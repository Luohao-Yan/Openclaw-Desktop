      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            <div className="p-3 bg-tech-teal/10 rounded-xl">
              <Server className="w-8 h-8 text-tech-teal" />
            </div>
            <div>
              <h1 className="text-3xl font-bold" style={{ color: 'var(--app-text)' }}>{t('instances.title')}</h1>
